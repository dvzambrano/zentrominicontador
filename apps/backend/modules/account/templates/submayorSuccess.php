    ...
    <div id="content">
        <div class="page" style="font-size: 7pt">
            ...
            <table class="change_order_items">
                ...
                <tr>
                    <td colspan="12" style="text-align: center;border-bottom: 1px solid black;"><b>SUBMAYOR</b></td>
                </tr>

                <tr>
                    <td colspan="3" rowspan="2" style="vertical-align: top;"><?php echo $entity['name'] ?><br/><?php echo $entity['comment'] ?></td>
                </tr>
                <tr>
                    <td colspan="5" style="text-align: justify;"><b>Nombre</b><br/>
                    ...
                    <td colspan="4" style="text-align: justify;"><b>C&oacute;digo</b><br/>
                        <?php foreach ($accounts as $item): ?>
                            <?php
                            $pieces = explode('.', $item["code"]);
                            foreach ($pieces as $piece):
                ...
                <tr class="even_row"> 
                    <td colspan="8" rowspan="2"><b>Autorizado</b></td>
